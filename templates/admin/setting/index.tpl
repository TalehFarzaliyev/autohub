								...
								{if isset($language_list) && is_object($language_list)}
									{foreach $language_list as $language}
										<div class="form-group">										
											<div class="col-sm-12"> <div class="input-group"><span class="input-group-addon"><img src="{base_url('templates/admin/assets/images/flags/')}{$language->code}.png" title="English"></span>
