<div class="panel panel-white">
            ...
            <div class="row">
                <div class="col-md-11" style="padding-top: 5px">
                    {foreach $columns as $column} 
                        <label class="checkbox-inline"><input type="checkbox" class="styled table-column-checkbox" checked="checked" value="{$column}">{$text.menu["menu_table_head_{$column}"]}</label></a>
                    {/foreach}
                </div>
                <div class="col-md-1">				
    ...
    {form_open_multipart(site_url_multi('admin/menu/delete'), 'class="form-horizontal" id="form-list"')}
    {$table}
    {form_close()}
