                          ...
                          <div class="panel-body">
                              ...
                              <div class="form-group ">
                                  ...
                                  <select name="status" id="status" class="bootstrap-select" data-style="btn-default btn-xs" data-width="100%">
                                      <option value="0" {if $value.status eq 0} selected="selected" {/if}>Disable</option>
                                      <option value="1" {if $value.status eq 1} selected="selected" {/if}>Enable</option>
                                  </select>
                              </div>
                              <div class="form-group">
                                  <label></label>
