...
class Page extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->data['columns'] = ['id', 'name', 'subtitle', 'slug', 'status'];
		...
		$this->data['action'] = [
			...
			'custom'	=> [
				[
					...
					'href_value'	=> 'slug',
					'icon'			=> 'icon-eye',
					'text'			=> $this->data['text']['common']['common_view']
				]
			]
		];
	...
	public function create()
	{
		...
		foreach ($this->data['language_list'] as $language)
		{
			$this->data['form_field']['translation'][$language->id] = [
				...
				'subtitle' => [
					'property'		=> 'input',
					'name'          => 'translation['.$language->id.'][subtitle]',
			        'class'			=> 'form-control',
			        'value'         => set_value('translation['.$language->id.'][subtitle]'),
			        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_subtitle'],
			        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_subtitle'],
			        'validation'	=> ['rules' => '']
				],
				'slug' => [
					'property'		=> 'input',
		...
		$this->data['form_field']['general'] = [
			...
			'template'		=> [
				...
				'name'          => 'template',
		        'class'			=> 'form-control',
		        'value'         => set_value('template'),
			    'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_template'],
		        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_template'],
		        'validation'	=> ['rules' => '']
		    ],
		    'status'		=> [		    	
				'property'		=> 'dropdown',
			...
			if($this->data['general'])
			{
				...
				$this->data['form_field']['general'] = [
					...
					'template'		=> [
						...
						'name'          => 'template',
				        'class'			=> 'form-control',
				        'value'         => (set_value('template')) ? set_value('template') : $this->data['general']->template,
					    'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_template'],
				        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_template'],
				        'validation'	=> ['rules' => '']
				    ],
				...
				$this->data['columns'] = ['name', 'subtitle', 'slug', 'description', 'meta_title', 'meta_description', 'meta_keyword'];
				...
				foreach ($this->data['language_list'] as $language)
				{
					...
					$this->data['form_field']['translation'][$language->id] = [
						...
						'subtitle' => [
							...
							'name'          => 'translation['.$language->id.'][subtitle]',
					        'class'			=> 'form-control',
					        'value'         => (set_value('translation['.$language->id.'][subtitle]')) ? set_value('translation['.$language->id.'][subtitle]') : $this->data['translation'][$language->id]['subtitle'],
					        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_subtitle'],
					        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_subtitle'],
					        'validation'	=> ['rules' => '']
						],
						...
						'description' => [
							...
							'name'          => 'translation['.$language->id.'][description]',
					        'class'			=> 'form-control editor',
					        'value'         => (set_value('translation['.$language->id.'][description]')) ? set_value('translation['.$language->id.'][description]') : html_entity_decode($this->data['translation'][$language->id]['description'], ENT_QUOTES, 'UTF-8'),
					        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_description'],
					        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_description'],
					        'validation'	=> ['rules' => 'required']
						],
