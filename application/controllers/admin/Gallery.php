...
class Gallery extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->data['columns'] = ['id', 'image', 'video','status'];
		$this->data['filter'] = [];
	...
	public function trash()
	{
		...
		$this->data['columns'] = ['id', 'image', 'status'];
	...
	public function create()
	{
		...
		$this->data['form_field']['general'] = [
			...
			'Video' => [
			        ...
			        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_video'],
			        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_video'],
				    'validation'	=> [
		                'rules' => ''
		        	]
			],
		...
		if($this->input->method() == 'post')
		{
			if ($this->form_validation->run() == TRUE)
            {
            	...
            	$video_input = $this->input->post('video');
			...
			if($this->data['general'])
			{
				...
				$this->data['form_field']['general'] = [
					...
					'Video' => [
						...
						'name'          => 'video',
				        'class'			=> 'form-control',
				        'value'         => set_value('video') ? set_value('video') : $this->data['general']->video,
				        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_video'],
				        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_video'],
					    'validation'	=> [
			                'rules' => ''
