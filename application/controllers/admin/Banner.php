...
class Banner extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->data['columns'] = ['id', 'name', 'link', 'image', 'status'];
		...
		foreach ($this->data['language_list'] as $language)
		{
			$this->data['form_field']['translation'][$language->id] = [
				...
				'link' => [
			        ...
			        'class'			=> 'form-control',
			        'value'         => set_value('translation['.$language->id.'][link]'),
				...
				'image'		=> [
					...
					'name'          	=> 'translation['.$language->id.'][image]',
			        'value'         	=> set_value('translation['.$language->id.'][image]'),
			        'src'        		=> set_value('translation['.$language->id.'][image]') ? $this->Model_tool_image->resize(set_value('translation['.$language->id.'][image]'), 200, 200) : $this->Model_tool_image->resize('catalog/nophoto.png', 200, 200),
				...
				'image'		=> [
				    ...
				    'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_image'],
			        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_image'],
			        'validation'	=> [
		                'rules' => '',
		            ]
		    	]
		...
		if($this->input->method() == 'post')
		{
			if ($this->form_validation->run() == TRUE)
            {
            	...
            	foreach ($this->input->post('translation') as $lang_id => $value)
            	{
            		...
            		$this->{$this->model}->insert($translation);
            	}
	...
	public function edit($id = false)
	{
		if($id && ctype_digit($id))
		{
			...
			if($this->data['general'])
			{
				...
				$this->data['columns'] = ['title', 'description', 'image', 'link'];
				...
				foreach ($this->data['language_list'] as $language)
				{
					...
					$this->data['form_field']['translation'][$language->id] = [
						'title' => [
					        ...
					        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_title'],
					        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_title'],
						    'validation'	=> [
				                'rules' => 'required',
				            ]
						],
						'link' => [
							...
							'name'          => 'translation['.$language->id.'][link]',
					        'class'			=> 'form-control',
					        'value'         => (set_value('translation['.$language->id.'][link]')) ? set_value('translation['.$language->id.'][link]') : $this->data['translation'][$language->id]['link'],
					        'label'			=> $this->data['text'][$this->controller][$this->controller.'_form_label_link'],
					        'placeholder'	=> $this->data['text'][$this->controller][$this->controller.'_form_placeholder_link'],
						    'validation'	=> [
				                'rules' => 'required',
				                'errors' => [
				                	'required' => $this->lang->translate($this->controller.'_form_error_required_link'),
				                ]
				        	]
						],
						'description' => [
					        ...
					        'validation'	=> [
				                'rules' => 'required',
				                'errors' => [
				                	'required' => $this->lang->translate($this->controller.'_form_error_required_description'),
				                ]
				        	]
						],
						'image'		=> [
							...
							'id'       			=> 'input-image-'.$language->id,
							'name'          	=> 'translation['.$language->id.'][image]',
					        'value'         	=> (set_value('translation['.$language->id.'][image]')) ? set_value('translation['.$language->id.'][image]') : $this->data['translation'][$language->id]['image'],
					        'src'        		=> (set_value('translation['.$language->id.'][image]')) ? $this->Model_tool_image->resize(set_value('translation['.$language->id.'][image]'), 200, 200) : $this->Model_tool_image->resize($this->data['translation'][$language->id]['image'], 200, 200),
						    'label'				=> $this->data['text'][$this->controller][$this->controller.'_form_label_image'],
