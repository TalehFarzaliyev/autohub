    ...
    function get_menu_by_name($name = false)
    {
        ...
        if($name)
        {
            ...
            if($query->num_rows() == 1)
            {
                ...
                $config["parent_tag_close"]      = '</li>';
                $config["parent_anchor"]     = '<a  href="%s" class="dropdown-toggle category03" data-toggle="dropdown">%s<span class="pe-7s-angle-down"></span></a>';
    ...
    function get_menu_by_mobile($name = false)
    {
        ...
        if($name)
        {
            ...
            if($query->num_rows() == 1)
            {
                ...
                $config["parent_tag_open"]       = '<li>';
                $config["parent_tag_close"]      = '</li>';
                $config["parent_anchor"]     = '<a  href="%s" >%s<span class="fa arrow"></span></a>';
